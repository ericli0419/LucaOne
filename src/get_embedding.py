...
try:
    ...
    from utils import set_seed, to_device, get_labels, get_parameter_number, gene_seq_replace, matrix_2_vector, \
    ...
    from src.utils import set_seed, to_device, get_labels, get_parameter_number, gene_seq_replace, matrix_2_vector, \
        download_trained_checkpoint_lucaone, clean_seq_luca, available_gpu_id, calc_emb_filename_by_seq_id, seq_type_is_match_seq
